...
def extract_data():
    ...
    ### Perform the request ###
    try:
        logging.info(DATABASE_LOCATION)
        logging.info(USER_ID)
        logging.info(headers)
        conn=cli.HTTPSConnection("api.spotify.com",port=None)
        conn.request("GET","/v1/me/following?type=artist",body=None,headers=headers)
